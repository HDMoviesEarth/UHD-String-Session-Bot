...
async def get_fsub(bot: Client, message: Message) -> bool:
    ...
    if not_joined_channels:
        ...
        await message.reply(f"**😄 {message.from_user.mention}, ʏᴏᴜ'ʀᴇ ɴᴏᴛ ᴊᴏɪɴᴇᴅ ᴛᴏ ᴀʟʟ ʀᴇǫᴜɪʀᴇᴅ ᴄʜᴀɴɴᴇʟs, ᴊᴏɪɴ ᴛʜᴇ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟs ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ.**", reply_markup=InlineKeyboardMarkup(join_buttons))
        return False
    return True
